...
var parse = function parse(input) {
  function parseComponent(_x) {
    return _parseComponent.apply(this, arguments);
  }
  function _parseComponent() {
    _parseComponent = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(inputComponent) {
      var document;
